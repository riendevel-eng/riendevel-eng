...
I am a software developer focused on building **automation tools, backend systems, and Discord bots**. I enjoy turning practical ideas into reliable software with an emphasis on maintainability and usability.

### What I'm working on

- 🔭 **Sorasaki Hina** — A feature-rich Discord bot with music playback, AI chat integration, moderation, and AutoMod.
- 💬 **Areas of interest** — Discord bot development, API integration, and automation.
- 🧩 **Approach** — Clean architecture, maintainable code, and practical solutions.
...
`Music` · `AI Chat` · `Moderation` · `AutoMod`
...
| Area | Focus |
|---|---|
| 🤖 Discord | Bots, moderation, AutoMod, integrations |
| ⚙️ Automation | Tools and workflows that reduce repetitive work |
| 🔌 APIs | Integrations and backend services |
| 🧱 Backend | Reliable and maintainable application logic |
